export const homeObjOne = {
    ...
    lightTextDesc: true,
    topLine: 'HELLO THERE',
    headline: 'We Are Delivery',
    description: 'At our delivery service, we prioritize your safety and data security. Using advanced encryption and strict access controls, we ensure your delivery details are protected from unauthorized access, giving you peace of mind throughout the process.',
...
export const homeObjTwo = {
    ...
    headline: 'Deliver From Anywhere',
